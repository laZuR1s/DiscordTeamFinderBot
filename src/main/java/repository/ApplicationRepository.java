...
public class ApplicationRepository {
    ...
    public Application getUserApplication(long userId) {
    ...
    public void updateApplicationFull(
            long userId,
            int gameId,
            String description,
            int playersNeeded
        ...
        try (Connection connection = DatabaseConfig.getConnection();
            ...
            statement.setInt(3, playersNeeded);
            statement.setLong(4, userId);

            int updated = statement.executeUpdate();

            if (updated == 0) {
                throw new RuntimeException("Application not found for userId=" + userId);
            }
